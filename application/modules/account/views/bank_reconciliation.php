    ...
    <div class="col-sm-12 col-md-12">
        <div class="panel panel-bd">             
            ...
            <div class="panel-body">
              ...
              <?php echo  form_open_multipart('account/accounts/bank_reconciliation',array('class' => 'form-inline','method'=>'post')) ?>
                <div class="row" >
                    <div class="col-sm-3">
...
<div class="row">
    <?php echo  form_open_multipart('account/accounts/bank_reconciliation_approve', array('onsubmit'=>'return checkValue();')) ?>
    <div class="col-sm-12 col-md-12">
        <div class="panel panel-bd lobidrag">
            <div class="panel-heading">                
                <div class="panel-title">
                    <h3><?php echo display('bank_reconciliation');?> </h3> 
                    <?php if($this->permission1->method('bank_reconciliation','update')->access()) { ?>
                    ...
                    <table class="datatableReport table table-bordered table-hover">
                        ...
                        <tbody> 
                            ...
                            foreach($vauchers as $appr) {  $sum += $appr->Debit;
                                if($appr->isHonour == 1) {?> <tr id="t-<?php echo $sl;?>" style="background-color:#151B8D !important; color: #fff !important;"> <?php } else { ?><tr id="t-<?php echo $sl;?>" > <?php } ?>
                           ...
                           <?php $sl++;}?>
                           <tr>
                                <td style="border-bottom: 1px solid #ddd;"> <input type="checkbox" value="1" name="selectAll" id="selectAll2"  data-property="<?php echo count($vauchers);?>" onclick="checkAll(this)"/> &nbsp; Select All</td>
                                <td  style="border-bottom: 1px solid #ddd;"colspan="6" align="right"> <strong><?php echo display('total');?> </strong></td>
                                <td style="border-bottom: 1px solid #ddd;"><strong><?php echo $sum; ?></strong></td>
                           </tr>
                        </tbody>
                    </table>
                 <?php } else { ?>
...
<script src="<?php echo base_url('my-assets/js/admin_js/bank_reconciliation.js') ?>" type="text/javascript"></script>
