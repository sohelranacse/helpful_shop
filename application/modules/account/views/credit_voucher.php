                        ...
                        <tbody id="creditvoucher">
                            <tr>
                                <td class="expenseincometd">
                                    <select name="cmbCode[]" id="cmbCode_1" required class="form-control"
                                ...
                                <td><input type="number" name="txtAmount[]" required step=".01" value=""
                                        class="form-control total_price text-right" id="txtAmount_1"
                                        onkeyup="calculationCreditv(1)">
                                </td>
                                <td>
                                    <button class="btn btn-danger red text-right" type="button"
                                        value="<?php echo display('delete')?>" onclick="deleteRowCreditv(this)"><i
                            ...
                            <tr>
                                <td>
                                    <input type="button" id="add_more" class="btn btn-info" name="add_more"
                                        onClick="addaccountCreditv('creditvoucher');"
