<div class="col-md-12" id="vaucherPrintArea">
    ...
    <table class="table table-bordered table-sm mt-2">
        ...
        <tbody>
            ...
            <tr>
                <td><strong
                        style="font-size: 15px;;"><?php echo $row->HeadName.($row->subType != 1?'('.$row->subname.')':'');?></strong><br>
            ...
            <tr>
                ...
                <td class="text-right"><?php echo $settings_info->currency . ' ' .number_format($Credit, 2); ?></td>
                <td class="text-right"><?php echo $settings_info->currency.' ' . '0.00';?></td>
        ...
        <tfoot>
            <tr>
                ...
                <th class="text-right"><?php echo $settings_info->currency. ' '. number_format($Credit, 2); ?></th>
                <th class="text-right"><?php echo $settings_info->currency. ' '. number_format($Credit, 2); ?></th>
            </tr>
