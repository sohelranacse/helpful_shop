                    ...
                    <table class="table table-bordered table-hover" id="debtAccVoucher">
                        ...
                        <tbody id="debitvoucher">
                            ...
                            <tr>
                                ...
                                <td><input type="number" name="txtAmount[]" value="" required
                                        class="form-control total_price text-right" step=".01" id="txtAmount_1"
                                        onkeyup="calculationDebtv(1)">
                                </td>
                                <td>
                                    <button class="btn btn-danger red text-right" type="button"
                                        value="<?php echo display('delete')?>" onclick="deleteRowDebtv(this)"><i
                            ...
                            <tr>
                                <td>
                                    <input type="button" id="add_more" class="btn btn-info" name="add_more"
                                        onClick="addaccountDebt('debitvoucher');"
