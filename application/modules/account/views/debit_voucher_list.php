        ...
        <div class="panel panel-bd lobidrag">
            ...
            <div class="panel-heading">
                <div class="panel-title">
                    <span><?php echo display('debit_voucher') ?></span>
                    <span class="padding-lefttitle">
                        <?php if($this->permission1->method('debit_voucher','create')->access()): ?>
                        <a href="<?php echo base_url("create_debit_voucher") ?>" class="btn btn-primary btn-md"><i
                                class="fa fa-plus-circle" aria-hidden="true"></i>
                            <?php echo display('create_debit_voucher');?></a>
            ...
            <div class="panel-body">
                <table width="100%" class="datatableReport table table-striped table-bordered table-hover"  cellspacing="0" width="100%" id="debitvList" title="devitVoucher">
                    <thead>
                        <tr>
    ...
    <div class="modal-dialog custom-modal-dialog" style="min-width: 76%;">
        <div class="modal-content ">
            ...
            <div class="p-20 text-right">
                <button class="btn btn-warning" name="btnPrint" id="btnPrint"
                    onclick="printVaucher('vaucherPrintArea');"><i class='fa fa-print'></i> Print </button>

                <button type="button" class="btn btn-danger" data-dismiss="modal"><i class='fa fa-cross'></i>
                    close</button>
            </div>
        </div>
    </div>
...
<script src="<?php echo base_url('my-assets/js/admin_js/debit_voucher_list.js') ?>" type="text/javascript"></script>
