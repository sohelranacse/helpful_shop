    ...
    <table  width="99%" class="table table-bordered table-sm mt-2">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td align="right" class="text-right"><?php echo $settings_info->currency_symbol. ' '. number_format($Debit, 2); ?></td>
            ...
            <tr>
                ...
                <th align="left" class="" colspan="3"><?php echo display('in_words');?> : <?php echo $numberToword->convert_number($Debit). " Dalasi"; ?></th>
