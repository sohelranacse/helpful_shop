        ...
        <div class="panel panel-bd lobidrag"> 
            ...
            <div class="panel-heading">
                <div class="panel-title">
                    <span><?php echo display('financial_year') ?></span>
                    <span class="padding-lefttitle">
                    <?php if($this->permission1->method('financiall_year','update')->access()): ?>
                    ...
                    <?php endif; ?> 
                    <?php if($this->permission1->method('financiall_year','create')->access()): ?>
                               ...
                               ?>         
                                   ...
                                   <td class="center">
                                    <?php if($row->isCloseReq == 0 ){
                                        ...
                                        if($this->permission1->method('financiall_year','update')->access()): ?>                                           
                                        <a href="#" class="btn btn-xs btn-success" onclick="edit_financial_year('<?php echo $row->id;?>');"><i class="fa fa-pencil"></i></a> 
                                        <?php endif; ?>
                                        
                                        <?php if($this->permission1->method('financiall_year','update')->access()) {  ?> 
                                             <a href="<?php echo base_url("account/accounts/delete_financial_year/$row->id") ?>" class="btn btn-xs btn-danger"  onclick="return confirm('<?php echo display('are_you_sure') ?>') "><i class="fa fa-trash"></i></a> 
                                             <?php } } 
                                              if($this->permission1->method('financiall_year','update')->access()) {
                                             if($lastclosedid) {
                                                if($row->isCloseReq==1 && $lastclosedid ==$row->id ){ ?>
                                                    <a href="<?php echo base_url("account/accounts/reversed_financial_year/$row->id") ?>" class="btn btn-xs btn-success" onclick=" return confm('Are you sure want to reverse the closing financial year?');"><i class="fa fa-undo"></i> Reversed</a> 
        ...
        <div class="col-sm-12 col-md-12">
            <div class="panel">
                ...
                <div class="panel-body">
                    ...
                    <?php echo  form_open_multipart('financial_year', array('id'=>"fyearModalForm")); ?>
                   
                        <input type="hidden" name="rid" id="rid" value="">
                        <div class="form-group row">
                            <label for="financial_year" class="col-sm-2 col-form-label"><?php echo display('financial_year') ?>*</label>
                            <div class="col-sm-4">
                                <input type="text" name="financial_year" class="form-control financial_year " required id="financial_year" placeholder="<?php echo display('financial_year') ?>" />
                            </div>
                            <label for="financial_year" class="col-sm-2 col-form-label"><?php echo display('status') ?>*</label>
                            <div class="col-sm-4">
                            <!-- <input type="checkbox" name="status" class="is-qr-pos"  value="1"> -->
                                <select name="status" class="form-control financial_year" >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                           <input type="text" name="financial_year_start_date" autocomplete="off" required class=" form-control datepicker apply_start" id="apply_start" placeholder="<?php echo display('financial_year_start_date') ?>">
                            </div>
                             <label for="financial_year_end_date" class="col-sm-2 col-form-label">
                            <?php echo display('financial_year_end_date') ?>*</label>
                            <div class="col-sm-4">
                           <input type="text" name="financial_year_end_date" autocomplete="off" required class="form-control datepicker apply_end" id="apply_end" placeholder="<?php echo display('financial_year_end_date') ?>">
...
<div id="fyear" class="modal fade" role="dialog">
        ...
        <div class="col-sm-12 col-md-12">
            <div class="panel">
                ...
                <div class="panel-body">
                    ...
                    <?php echo  form_open_multipart('account/accounts/year_closing', array('id'=>"fyearCloseForm", 'onsubmit'=>'return confirmSubmit();')); ?>
                        ...
                        <div class="form-group form-group-margin text-right">
                            ...
                            <button type="submit" class="btn btn-success w-md m-b-5 save_btn"><?php echo display('year_closing') ?></button>
                        </div>
                    <?php echo form_close() ?>
    ...
    <script src="<?php echo base_url('my-assets/js/admin_js/financial_year_list.js') ?>" type="text/javascript"></script>
