                ...
                <div class="panel-body">
                    <div bgcolor='#e4e4e4' text='#ff6633' link='#666666' vlink='#666666' alink='#ff6633' class="phdiv">
                        <table border="0" width="100%">
                            <tr>
                                <td>
                                    ...
                                    <table border="0" width="100%">
                                        ...
                                        <tr>
                                            <td align="center">
                                                <b><?php echo  html_escape($customer_info[0]['customer_name']);?></b><br>
                                        ...
                                        <tr>
                                            <td class="text-left"><?php echo display('amount'); ?> :
                                                <?php echo  html_escape($payment_info[0]['sumcredit']);?></td>
                            ...
                            <tr>
                                <td>Powered By: <a
                                        href="javascript:void(0)"><?php echo $company_info[0]['company_name']?></a></td>
