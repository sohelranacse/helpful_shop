    ...
    <div class="col-sm-12 col-md-12">
        <div class="panel panel-bd lobidrag">
            ...
            <div class="panel-body">
                <?php echo  form_open_multipart('account/accounts/store_journal_voucher') ?>
                        ...
                        <tbody id="debitvoucher">
                            <tr>
                                ...
                                <td><input type="hidden" name="isSubtype[]" id="isSubtype_1" value="1" />
                                    <input type="text" name="txtComment[]" value="" class="form-control "
                                        id="txtComment_1">
                                </td>
                                <td><input type="number" name="txtAmount[]" value="" step=".01" placeholder="0.00"
                                        class="form-control total_price text-right" id="txtAmount_1"
                                        onkeyup="calculationJournalv(1)">
                                </td>
                                <td><input type="number" name="txtAmountcr[]" value="" step=".01" placeholder="0.00"
                                        class="form-control total_price1 text-right" id="txtAmount1_1"
                                        onkeyup="calculationJournalv(1)">
                                </td>

                                <td>
                                    <select name="cmbDebit[]" id="cmbDebit_1" class="form-control" required>
                                        <option value="">Please select One</option>
                                        <?php foreach ($acc as $cracc) { ?>
                                        <option value="<?php echo $cracc->HeadCode?>"><?php echo $cracc->HeadName?>
                                        </option>
                                        <?php  } ?>
                                ...
                                <td>
                                    <button class="btn btn-danger red" type="button"
                                        value="<?php echo display('delete')?>" onclick="deleteRowJournalv(this)"><i
                            ...
                            <tr>
                                <td>
                                    <input type="button" id="add_more" class="btn btn-info" name="add_more"
                                        onClick="addaccountJournalv('debitvoucher');"
