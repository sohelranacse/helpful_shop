    ...
    <div class="col-sm-12 col-md-12">
        <div class="panel panel-bd">
            ...
            <div class="panel-body">
                         ...
                         <?php echo  form_open_multipart('account/accounts/create_opening_balance') ?>
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                             <input type="text" name="dtpDate" id="dtpDate" class="form-control datepicker" value="<?php echo date("Y-m-d", strtotime('first day of January '.date('Y') )); ?>">
                        </div>
                    </div> 
                        ...
                        <table class="table table-bordered table-hover" id="debtAccVoucher"> 
                            ...
                            <tbody id="debitvoucher">
                               <tr>
                                  ...
                                  <td >  
                                       <select name="subtype[]" id="subtype_1" required class="form-control" ><option value="">Please select One</option></select>
