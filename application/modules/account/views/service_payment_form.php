        ...
        <div class="panel panel-bd lobidrag">
            <div class="panel-heading">
                <div class="panel-title">
                    <h4>
                        <?php echo display('service_payment')?>
                    </h4>
                </div>
            </div>
            <div class="panel-body">

                <?php echo  form_open_multipart('account/accounts/create_service_payment','id="create_service_payment"') ?>
                            ...
                            <tr>
                                <td class="" width="300">
                                    <select name="customer_id" id="customer_id_1" class="form-control"
                                        onchange="load_customer_service_code(this.value,1)" required>
                                ...
                                <td><input type="hidden" name="txtCode" value="" class="form-control " id="txtCode_1"
                                        readonly="">
                                    <?php echo  form_dropdown('voucher_no',null,null, 'class="form-control select2" required id="voucher_no_1" onchange="customerservicevoucher_due(this.value)"') ?>
                                </td>
                                ...
                                <td><input type="number" step="0.01" name="txtAmount" value=""
                                        ...
                                        onkeyup="CustomerServiceRcvcalculation(1)" required>
                                </td>
...
<script src="<?php echo base_url('my-assets/js/admin_js/service_payment_form.js') ?>" type="text/javascript"></script>
