                ...
                <div bgcolor='#e4e4e4' text='#ff6633' link='#666666' vlink='#666666' alink='#ff6633' class="phdiv">
                    <div style="width: 33.33333333%;float: right;">
                        ...
                        <div>
                            ...
                            <?php echo $payment_info[0]['chalan_no']?>
                        </div>
                        ...
                        <address style="margin-top: 10px;" class="">
                            <strong class=""><?php echo $supplier_info[0]['supplier_name']?> </strong><br>
                            <?php echo $supplier_info[0]['address'];?>
                            <br>
                            <?php if ($supplier_info[0]['mobile']) { ?>
                            <abbr style="font-weight: bold;"><?php echo display('mobile') ?>: </abbr>
                            <?php echo $supplier_info[0]['mobile'];?>
                            <br>
                            <?php } ?>
                            <?php if ($supplier_info[0]['emailnumber']) { ?>
                            <abbr style="font-weight: bold;"><?php echo display('email') ?>: </abbr>
                            <?php echo $supplier_info[0]['emailnumber'];?>
                            <br>
                            <?php } ?>
                        </address>
                    ...
                    <div style="margin-bottom: 20px;width: 100%;">
                        <table width="100%" class="table2">
                            ...
                            <tr>
                                ...
                                <td style="text-align: center;"><?php echo  $payment_info[0]['sumDebit']?></td>
