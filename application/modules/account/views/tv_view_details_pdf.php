    ...
    <table  width="99%" class="table table-bordered table-sm mt-2">
        ...
        <tbody>
            ...
            if(!empty($results)){
            	...
            	?>
            	<tr>
            		<td align="left"><strong style="font-size: 15px;;"><?php echo $row->HeadName;?></strong><br>
        	...
        	<?php } }else{ ?>
                <tr>
                    <td align="left"  colspan="3" class="text-center text-danger"><?php echo get_notify('data_is_not_available');?></td>
                </tr>
            <?php }?>
            <tr>
                <td align="left" class="text-left"><strong style="font-size: 15px;"><?php echo $results->dbtcrdHead;?></strong></td>
                <td align="right" class="text-right"><?php echo $settings_info->currency_symbol. ' '.  ($row->Debit == '0.00'?$row->Credit:0);?></td>
                <td align="right" class="text-right"><?php echo  $settings_info->currency_symbol. ' '. ($row->Credit == '0.00'?$row->Debit:0);?></td>
        ...
        <tfoot>
        	<tr>
        		...
        		<th align="right" class="text-right"><?php echo $settings_info->currency_symbol. ' '. number_format($Debit, 2); ?></th>
        		<th align="right" class="text-right"><?php echo $settings_info->currency_symbol. ' '. number_format($Credit, 2); ?></th>
        	</tr>
            <tr>
        		
        		<th align="left" class="" colspan="3"><?php echo display('in_words');?> : <?php
                   $wordsamount = $Debit;
                     echo $numberToword->convert_number($wordsamount). " Dalasi"; ?></th>
                   ...
                   <tr >
                    <td colspan="3" class="noborder">
                       <table border="0" width="100%">                                                
                        <tr>
                            <td width="30%" align="left" class="noborder">
                                <div class="border-top"><?php echo display('prepared_by')?>: <?php echo $results->created_by;?></div>
                            </td>
                            <td width="40%"  align="center"  class="noborder"> <div class="border-top"><?php echo display('checked_by')?></div>
                            </td>  
                             <td width="30%"  align="right"  class="noborder">
