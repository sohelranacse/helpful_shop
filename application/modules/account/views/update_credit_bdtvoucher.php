    ...
    <div class="col-sm-12 col-md-12">
        <div class="panel panel-bd">
            ...
            <div class="panel-body">
                <?php echo  form_open_multipart('account/accounts/update_credit_voucher') ?>
                  ...
                  <?php  $sl = 1; $total=0;
                   foreach ($voucher_info as $voucher){ ?>                           
                     <tr>
                        ...
                        <td><input type="number" name="txtAmount[]" required value="<?php echo $voucher->Credit;?>" class="form-control total_price text-right"  id="txtAmount_<?php echo $sl; ?>" onkeyup="calculationCreditv(<?php echo $sl; ?>)" >
                           </td>
                       <td>
