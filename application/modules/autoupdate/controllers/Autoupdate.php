...
//Get Update file
define('MIN_VERSION', file_get_contents('https://update.bdtask.com/saleserp/autoupdate/update_min_version'));
//Get Update file
define('MAX_VERSION', file_get_contents('https://update.bdtask.com/saleserp/autoupdate/update_max_version'));

//Get Update file
define('UPDATE_URL','https://update.bdtask.com/saleserp/autoupdate');
// Get latest version info
define('UPDATE_INFO_URL','https://update.bdtask.com/saleserp/autoupdate/update_info');
define('VERSION_PATH','https://update.bdtask.com/saleserp/versions/');
// CRM temporary path
