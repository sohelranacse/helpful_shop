                        ...
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                <?php echo  form_open('hrm/Salary_advance/create_salary_advance') ?>
                                    ...
                                    <div class="form-group row">
                                        <label for="amount" class="col-sm-3 col-form-label"><?php echo display('amount') ?><?php if(!empty($setting->currency)){echo '('.$setting->currency.')';}?> *</label>
                                        <div class="col-sm-9">
                                            <input type="number" id="amount" name="amount" class="form-control" placeholder="<?php echo display('amount') ?><?php if(!empty($setting->currency)){echo '('.$setting->currency.')';}?>" required>
                                        </div>
                                    </div>
        ...
        <div class="panel panel-bd lobidrag"> 
            ...
            <div class="panel-heading">
                <div class="panel-title">
                    <span><?php echo display('salary_advance_view') ?></span>
                    <span class="padding-lefttitle">
                    <?php if($this->permission1->method('salary_advance_view','create')->access()): ?>
                    ...
                    <?php if($this->permission1->method('salary_advance_view','read')->access()): ?>
                        ...
                        <a href="<?php echo base_url();?>manage_salary_advance" class="btn btn-primary"><?php echo display('manage_salary_advance')?></a>
                        ...
                        <?php if (!empty($salary_adv_list)) { ?>
                            ...
                            <?php foreach ($salary_adv_list as $salary_adv) { ?>
                                <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                                    ...
                                    <td><?php echo $setting->currency.' '.$salary_adv->amount; ?></td>
                                    <td><?php echo $setting->currency.' ';?><?php echo $salary_adv->release_amount > 0 ? $salary_adv->release_amount : 0; ?></td>
