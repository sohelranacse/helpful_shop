                ...
                <div class="row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <input type="text" required tabindex="2" class="form-control datepicker"
                                    name="sales_date" value="<?php echo $date; ?>" id="date" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <textarea class="form-control" tabindex="4" id="adress" name="invoice_details"
                    ...
                    <table class="table table-bordered table-hover" id="purchaseTable" style="font-size: 12px">
                        ...
                        <tfoot>
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    <input type="number" id="shipping_cost" class="text-right form-control" name="shipping_cost" placeholder="0.00" value="80" onkeyup="return summation_of_total_amount()" />
                                </td>
                                <td> </td>
                            </tr>
