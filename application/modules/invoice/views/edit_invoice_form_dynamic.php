                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="product_quantity[]"
                                        onkeyup="bdtask_invoice_quantity_calculate(<?php echo $details['sl']?>);"
                                        onchange="bdtask_invoice_quantity_calculate(<?php echo $details['sl']?>);"
                                ...
                                <td>
                                    ...
                                    <?php $x=0;
                                            foreach($taxes as $taxfldt){
                                                $taxval='tax'.$x;
                                                ?>
                                    <input id="total_tax<?php echo $x;?>_<?php echo $details['sl']?>"
                                        class="total_tax<?php echo $x;?>_<?php echo $details['sl']?>"
                                        value="<?php echo $details[$taxval]?>" type="hidden">
                                    <input id="all_tax<?php echo $x;?>_<?php echo $details['sl']?>"
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <td><a id="add_invoice_item" class="btn btn-info" name="add-invoice-item"
                                        onClick="addInputField_invoice_dynamic('addinvoiceItem');"><i
                            ...
                            <input type="hidden" id="total_vat_amnt" value="<?php echo $total_vat_amnt;?>"
                                name="total_vat_amnt" value="0.00" />
                            <?php $x=0;
                                     foreach($taxes as $taxfldt){?>
                            <tr class="hideableRow hiddenRow">

                                <td class="text-right" colspan="9">
                                    <b><?php echo html_escape($taxfldt['tax_name']) ?></b>
                                </td>
                                <td class="text-right">
                                    <input id="total_tax_ammount<?php echo $x;?>" tabindex="-1"
                                     ...
                                     echo html_escape($taxvalu[0][$txval])?>" readonly="readonly" aria-invalid="false"
                                        type="text">
                                </td>
                            </tr>
                            <?php $x++;}?>
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    <input id="total_tax_amount" tabindex="-1" class="form-control text-right valid"
                                        name="total_tax" value="<?php echo $total_tax;?>" readonly="readonly"
                            ...
                            <tr>
                                ...
                                <td class="text-right" colspan="9"><b><?php echo display('change') ?>:</b></td>
                                <td class="text-right">
