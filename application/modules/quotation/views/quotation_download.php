       ...
       if (!empty($quot_product[0]['product_name'])) {
        ...
        <div class="">
            <table class="table table-striped">
                <caption class="text-center">
                    <h2 style="border:1px;background-color: #DDE4EB;color:#000">
                        <?php echo display('item').' '.display('quotation')?> </h2>
                </caption>
                <thead>
                    ...
                    <tr>
                        ...
                        <th style="text-align: center;  padding: 5px;"><?php echo display('discount_percentage') ?> %
                        </th>
                ...
                <tfoot>
                    <tr>
                        <td colspan="8" style="text-align: right;padding:5px;">
                            <b><?php echo display('sub_total'); ?></b></td>
                    ...
                    <tr>
                        <td colspan="8" style="text-align: right;"><b><?php echo display('discount') ?></b></td>
                        <td align="right" style="padding:5px;"><b>
                                <?php
                    ...
                    <tr>
                        <td colspan="8" style="text-align: right;"><b><?php echo display('ttl_val') ?></b></td>
                        <td align="right" style="padding:5px;"><b>
                                <?php
                    ...
                    <?php } 
                    if ($quot_main[0]['item_total_tax'] != 0) {
                    ?>
                    <tr>
                        <td colspan="8" style="text-align: right;"><b><?php echo display('total_tax') ?></b></td>
                        <td align="right" style="padding:5px;"><b>
                                <?php
        ...
        <div class="table-responsive m-b-20">
            <table class="table table-striped">
                <caption class="text-center">
                    <h2 style="border:1px;background-color: #DDE4EB;color:#000">
                        <?php echo display('service').' '.display('quotation')?> </h2>
                </caption>
                <thead>
                    <tr>
                ...
                <tfoot>
                    ...
                    <tr>
                        <td colspan="8" style="text-align: right;  padding: 5px;">
                            <b><?php echo display('discount') ?></b></td>
                        <td align="right" style="padding: 5px;"><b>
                                <?php
                    ...
                    <tr>
                        <td colspan="8" style="text-align: right;  padding: 5px;">
                            <b><?php echo display('ttl_val') ?></b></td>
                        <td align="right" style="padding: 5px;"><b>
                                <?php
                    ...
                    <?php } 
                    if ($quot_main[0]['service_total_tax'] != 0) {
                    ?>

                    <tr>
                        <td colspan="8" style="text-align: right;  padding: 5px;"><b><?php echo display('tax') ?></b>
                        </td>
                        <td align="right" style="padding: 5px;"><b>
                                <?php
                ...
                <table class="table table-stripped">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <th colspan="2" style="text-align: right;  padding: 5px;"><?php echo display('net_total') ?>
                                :</th>
