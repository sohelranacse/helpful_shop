        ...
        <div class="panel panel-bd lobidrag">
            ...
            <div class="panel-body">
                <div class="form-group row">
                    <div class="col-sm-6">
                        <label for="customer" class="col-sm-4 col-form-label"><?php echo display('customer') ?> <i
                                class="text-danger">*</i></label>
                        <div class="col-sm-8">

                            <?php if ($user_type == 3) { ?>
                            <input type="text" name="cname" value="<?php echo $this->session->userdata('user_name') ?>"
                                class="form-control" readonly>
                            <input type="hidden" name="customer_id"
                                value="<?php echo $this->session->userdata('user_id') ?>" class="form-control">
                            <?php } else { ?>
                            <select name="customer_id" required class="form-control" onchange="get_customer_info(this.value)"
                    ...
                    <div class="col-sm-6">
                        <label for="qdate" class="col-sm-4 col-form-label"><?php echo display('quotation_date') ?><i
                                class="text-danger">*</i> </label>
                        <div class="col-sm-8">
                            <input type="text" required name="qdate" class="form-control datepicker" id="qdate"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <label for="expiry_date" class="col-sm-4 col-form-label"><?php echo display('expiry_date') ?> <i
                                class="text-danger">*</i> </label>
                        <div class="col-sm-8">
                            <input type="text" required name="expiry_date" class="form-control datepicker" id="expiry_date"
                                value="<?php echo date('Y-m-d') ?>">
                        </div>
                    </div>
                </div>
                            ...
                            <table class="table table-bordered table-hover" id="normalinvoice">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center invoice_fields"><?php echo display('rate') ?> <i
                                                class="text-danger">*</i></th>
                                ...
                                <tbody id="addinvoiceItem">
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" required name="product_rate[]" id="price_item_1"
                                                class="price_item1 price_item form-control text-right" tabindex="9"
                                                onkeyup="quantity_calculate(1);" onchange="quantity_calculate(1);"
                                        ...
                                        <td>
                                            <input type="text" name="discount[]" onkeyup="quantity_calculate(1);"
                                                ...
                                                class="form-control text-right" min="0" tabindex="10"
                                                placeholder="0.00" />
                                            <input type="hidden" value="<?php echo $discount_type?>"
                                                name="discount_type" id="discount_type_1">
                                        ...
                                        <td>
                                            <input type="text" name="vatpercent[]" onkeyup="quantity_calculate(1);"
                                                ...
                                                class="form-control text-right" min="0" tabindex="19"
                                                placeholder="0.00" />
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <td><a id="add_invoice_item" class="btn btn-info" name="add-invoice-item"
                                                onClick="addInputField('addinvoiceItem');" tabindex="11"><i
                            ...
                            <table class="table table-bordered table-hover" id="serviceInvoice">
                                ...
                                <tbody id="addservicedata">
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="service_rate[]" id="service_rate_1"
                                        ...
                                        <!-- VAT  -->
                                        <td>
                                            <input type="text" name="service_vatpercent[]"
                                                onkeyup="serviceCAlculation(1);" onchange="serviceCAlculation(1);"
                                                id="service_vat_percent_1" class="form-control text-right" min="0"
                                                tabindex="19" placeholder="0.00" />

                                        </td>
                                        <td>
                                            <input type="text" name="service_vatvalue[]" id="service_vat_value_1"
                                                class="form-control text-right service_total_vatamnt" min="0"
                                                tabindex="20" placeholder="0.00" readonly />
                                        </td>
                                        <!-- VAT end -->
                                ...
                                <tfoot>
                                    ...
                                    <tr>
                                        ...
                                        <td><button type="button" id="add_service_item" class="btn btn-info"
                                                name="add-invoice-item" onClick="addService('addservicedata');"><i
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            <input type="text" id="total_service_discount"
                                                class="form-control text-right" name="totalServiceDicount" value="0.00"
                                                readonly="readonly" />
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            <input type="text" id="service_total_vat_amnt"
                                                class="form-control text-right" name="service_total_vat_amnt"
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            <input type="text" id="serviceGrandTotal" class="form-control text-right"
                                                name="grand_total_service_amount" value="0.00" readonly="readonly" />
                                            <input type="hidden" id="is_quotation" value="" name="">
                                            <input type="hidden" name="" value="<?php echo $discount_type?>"
                                                id="discount_type">
                                        </td>
                                    </tr>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <input type="submit" id="add-quotation" class="btn btn-success btn-large" name="add-quotation"
