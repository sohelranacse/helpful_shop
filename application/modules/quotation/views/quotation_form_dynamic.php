                                ...
                                <tbody id="addinvoiceItem">
                                    <tr>
                                        <td class="product_field">
                                            <input type="text" name="product_name" required onkeypress="invoice_productList(1);"
                                ...
                                <tfoot>
                                    ...
                                    <tr>
                                        ...
                                        <td><button type="button" id="add_service_item" class="btn btn-info"
                                                ...
                                                onClick="addService_dynamic('addservicedata');"><i
                                    ...
                                    <input type="hidden" id="service_total_vat_amnt" name="service_total_vat_amnt" value="0.00" />
                                    ...
                                    <tr>
                                     ...
                                     foreach($taxes as $taxfldt){?>
                                            <input id="total_service_tax_amount<?php echo $x;?>" tabindex="-1"
                                                ...
                                                name="total_service_tax<?php echo $x;?>" value="0.00"
                                                readonly="readonly" aria-invalid="false" type="hidden">
                                            <?php $x++;}?>

                                            <input type="text" id="total_service_tax" class="form-control text-right"
                                                name="total_service_tax" value="0.00" readonly="readonly" />
                                        </td>
