                ...
                <div class="form-group row">
                    <div class="col-sm-6">
                        ...
                        <div class="col-sm-8">
                            ...
                            <select name="customer_id" id="customer_id" required class="form-control" onchange="get_customer_info(this.value)"
                            ...
                            <table class="table table-bordered table-hover" id="normalinvoice">
                                ...
                                <tbody id="addinvoiceItem">
                                    ...
                                    <tr>
                                        ...
                                        <td class="invoice_fields">
                                            <input type="text" name="product_rate[]" required id="price_item_<?php echo $sl;?>"
                                        ...
                                        <td>
                                            <input type="text" name="vatpercent[]"
                                                onkeyup="quantity_calculate(<?php echo $sl;?>);"
                                                onchange="quantity_calculate(<?php echo $sl;?>);"
                                                id="vat_percent_<?php echo $sl;?>" class="form-control text-right"
                                                min="0" value="<?php echo $item['vat_per']; ?>" tabindex="19"
                                                placeholder="0.00" />


                                        </td>
                                        <td>
                                            <input type="text" name="vatvalue[]" id="vat_value_<?php echo $sl;?>"
                                                class="form-control text-right total_vatamnt"
                                                value="<?php echo $item['vat_amnt']; ?>" min="0" tabindex="20"
                                                placeholder="0.00" readonly />
                                        </td>
                                        <!-- VAT end -->
                            ...
                            <table class="table table-bordered table-hover" id="serviceInvoice">
                                ...
                                <tbody id="addservicedata">
                                    ...
                                    <tr>
                                        ...
                                        <td class="invoice_fields">
                                            <input type="text" name="service_rate[]" required id="service_rate_<?php echo $sr;?>"
                                        ...
                                        <td>
                                            <input type="text" name="service_vatpercent[]"
                                                onkeyup="serviceCAlculation(<?php echo $sr;?>);"
                                                onchange="serviceCAlculation(<?php echo $sr;?>);"
                                                id="service_vat_percent_<?php echo $sr;?>"
                                                value="<?php echo $service['vat_per']; ?>"
                                                class="form-control text-right" min="0" tabindex="19"
                                                placeholder="0.00" />

                                        </td>
                                        <td>
                                            <input type="text" name="service_vatvalue[]"
                                                id="service_vat_value_<?php echo $sr;?>"
                                                class="form-control text-right service_total_vatamnt" min="0"
                                                tabindex="20" value="<?php echo $service['vat_amnt']; ?>"
                                                placeholder="0.00" readonly />
                                        </td>
                                        <!-- VAT end -->
                                    ...
                                    <tr>
                                        <td class="product_field">
                                            <input type="text" name="service_name" required onkeypress="invoice_serviceList(1);"
                                                class="form-control serviceSelection"
                                ...
                                <tfoot>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            <input type="text" id="serviceGrandTotal" class="form-control ser_grandTotalamnt text-right"
                            ...
                            <div id="adddiscount" class="display-none">
                                <div class="row no-gutters">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" id="ser_pamount_by_method" class="form-control ser_number ser_pay "
                                            name="ser_pamount_by_method[]"  onkeyup="serchangedueamount()"
                                            value="<?php echo $quot_main[0]['service_total_amount'];?>" placeholder="0" />
