    ...
    <div class="col-sm-12">
        <div class="panel panel-bd lobidrag">
            ...
            $available_quantity = $total_purchase->total_purchase - $total_sale->total_sale;
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="discountvalue[]"
                                                ...
                                                value="<?php echo $item['discount']; ?>" readonly />
                                        </td>
                                        ...
                                        <td>
                                            <input type="text" name="vatpercent[]"
                                                onkeyup="quantity_calculate(<?php echo $sl;?>);"
                                                onchange="quantity_calculate(<?php echo $sl;?>);"
                                                id="vat_percent_<?php echo $sl;?>"
                                                value="<?php echo $item['vat_per']; ?>" class="form-control text-right"
                                        ...
                                        <td>
                                            <input type="text" name="vatvalue[]" id="vat_value_<?php echo $sl;?>"
                                                ...
                                                value="<?php echo $item['vat_amnt']; ?>" placeholder="0.00" readonly />
                                        </td>
                                        <!-- VAT end -->
                ...
                <hr>
                <div>
                    <button type="button" class="btn btn-primary" id="service_quotation_div">Add Service
                        Quotation</button>
                </div>
                ...
                <div class="row" id="quotation_service">
                    <div class="col-sm-12">
                        <input type="hidden" id="is_quotation"
                            value="<?php echo (!empty($quot_service)?$quot_service[0]['service_id']:'');?>" name="">
                        <div class="table-responsive margin-top10">
                            <table class="table table-bordered table-hover" id="serviceInvoice">
                                ...
                                <tbody id="addservicedata">
                                    ...
                                    <tr>
                                        ...
                                        <td class="invoice_fields">
                                            <input type="text" name="service_rate[]" id="service_rate_<?php echo $sr;?>"
