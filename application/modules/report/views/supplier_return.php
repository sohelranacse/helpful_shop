		...
		<div class="row">
		    <div class="col-sm-12">
		        <div class="panel panel-bd lobidrag">
		            ...
		            <span>  <?php echo display('supplier_return') ?></span>
                ...
                <tr>
                    ...
                    <td align="center" class="print-cominfo">
                        ...
                        <br>
						 ...
						 <br>
                        <strong><?php echo display('supplier_return')?></strong>
                    </td>
                     ...
                     <td align="right" class="print-table-tr">
		                ...
		                <div class="table-responsive paddin5ps">
							...
							<tr>
								<td><?php echo $sl++;?></td>
								<td><?php echo $returns['purchase_id']?></td>
								<td><?php echo $returns['supplier_name']?></td>
								...
								?>
								<tr>
									<td colspan="5" class="text-center"> No Resutl Found</td>
								</tr>
