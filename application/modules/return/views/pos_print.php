        ...
        <div class="panel panel-bd">
            <div id="printableArea">
                    ...
                    <div class="invoice-wrap"
                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" align="center"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <th style="text-align: left;"><?php echo 'R '.display('invoice_no');?></th>
                                    <th style="text-align: right;"><?php echo $invoice_all_data[0]['return_id'];?></th>
                                </tr>
                                <tr>
                ...
                foreach($invoice_all_data as $invoice_data){
                    ...
                    $total_vat +=$invoice_data['vat_amnt'];
                    $total_tax +=$invoice_data['tax'];
                    $total_dis +=$invoice_data['discount'];
                    ?>
                                <tr>
                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" align="center"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <th style="text-align: left;"><?php echo $total_dis?></th>
                                    <th style="text-align: right;padding: 3px 10px 3px 0px">
                                ...
                                <?php } ?>
                                <tr>
                                    <th style="text-align: left;"><?php echo $invoice_all_data[0]['returnable_amount']?></span>
                                    </th>
                                    <th style="text-align: right;padding: 3px 10px 3px 0px">
                                        <?php echo display('adj_amount'); ?></th>
                                </tr>
                                <tr>
                                    <th style="text-align: left;"><span
                                            style="font-size: 16px;font-weight: 900;"><?php echo $invoice_all_data[0]['ret_adjust_amnt']?></span>
                                    </th>
                                    <th style="text-align: right;padding: 3px 10px 3px 0px">
