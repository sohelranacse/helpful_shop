        ...
        <div class="panel panel-bd">
                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-sm-8 company-content">
                            ...
                            <address class="margin-top10">
                                ...
                                <abbr><b><?php echo display('mobile') ?>:</b></abbr><?php echo $company_info[0]['mobile']?>
                                <br>
                    ...
                    <div class="table-responsive m-b-20">
                        <table class="table table-striped table-bordered">
                            <caption>
                                <center>
                                    <h4><?php echo display('ret_item') ?></h4>
                                </center>
                            </caption>
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div><strong><?php echo $details['product_name']?> -
                                                (<?php echo $details['product_model']?>)</strong></div>
                                    </td>
                                    ...
                                    <?php }else{ ?>
                                    <td align="center">
                                        <?php echo (($position==0)?$currency.' '.$details['deduction']:$details['deduction'].' '.$currency) ?>
                                    </td>
                                    <?php } ?>

                                    <td align="center">
                                        <?php echo (($position==0)?$currency.' '.$details['product_rate']:$details['product_rate'].' '. $currency) ?>
                                    </td>
                                    <td align="center">
                                        <?php echo (($position==0)?$currency.' '. $details['total_ret_amount']:$details['total_ret_amount'].' '.$currency) ?>
                                    </td>
                                </tr>
                                <?php }?>
                            </tbody>
                            <tfoot>
                                <td align="center" colspan="1"><b><?php echo display('nt_return')?>:</b></td>
                                <td></td>
                    ...
                    <div class="table-responsive m-b-20">
                        <table class="table table-striped table-bordered">
                            <caption>
                                <center>
                                    <h4><?php echo display('replaced_item') ?></h4>
                                </center>
                            </caption>
                            <thead>
                                <tr>
                            ...
                            <tbody>
								...
								$tot_quantity = 0;
								$totamnt = 0;
								foreach($item_replaced as $details1){?>
                                <tr>
                                    <td class="text-center"><?php echo $sl?></td>
                                    <td class="text-center">
                                        <div><strong><?php echo $details1['product_name']?> -
                                                (<?php echo $details1['product_model']?>)</strong></div>
                                    </td>
                                    <td align="center"><?php 
									$tot_quantity +=$details1['quantity'];
									echo $details1['quantity']?></td>

                                   
                                    <td align="center"><?php echo $details1['batch_id']?></td>
                                  
                                    <td align="center">
                                        <?php echo (($position==0)?$currency.' '.$details1['rate']:$details1['rate'].' '. $currency) ?>
                                    </td>
                                    <td align="center">
                                        <?php 
										$totamnt += $details1['paid_amount'];
										echo (($position==0)?$currency.' '. number_format($details1['paid_amount'], 2, '.', ','):number_format($details1['paid_amount'], 2, '.', ',').' '.$currency) ?>
                                    </td>
                                </tr>
                                <?php $sl++; }?>
                            </tbody>
                            <tfoot>
                                ...
                                <td></td>
                                <td align="center"><b><?php echo $tot_quantity?></b></td>
                                <td></td>
                                <td></td>

                                <td align="center">
                                    <b><?php echo (($position==0)?$currency.' '.number_format($totamnt, 2, '.', ','):number_format($totamnt, 2, '.', ',').' '.$currency) ?></b>
                                </td>
                            </tfoot>
                        </table>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-xs-4 inline-block">
                            ...
                            <table class="table">
                                ...
                                <?php } ?>
                                <tr>
                                    <th class="grand_total"><?php echo display('paid_amount') ?> :</th>
                                    <td class="grand_total">
                                        <?php echo (($position==0)?$currency.' '.number_format($item_replaced[0]['ret_adjust_amnt']):number_format($item_replaced[0]['ret_adjust_amnt']).' '.$currency) ?>
                                    </td>
                                </tr>
            ...
            <div class="panel-footer text-left">
                <a class="btn btn-danger"
                    href="<?php echo base_url('return_form');?>"><?php echo display('cancel') ?></a>
