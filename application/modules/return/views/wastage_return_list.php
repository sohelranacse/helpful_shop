                ...
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            ...
                            <td><?php echo $sl++;?></td>
                            <td>
                                <a href="<?php echo base_url() . 'invoice_return_details/'.$returns['return_id']; ?>">
                            ...
                            <td class="text-right"><?php echo (($position == 0) ? $currency.' '.$returns['net_total_amount']: $returns['net_total_amount'].' '.$currency) ?></td>
                                            <td>
                                    <center>
                                        <a href="<?php echo base_url() . 'invoice_return_details/'.$returns['return_id']; ?>" class="btn btn-success btn-sm" data-toggle="tooltip" data-placement="left" title="<?php echo display('details') ?>"><i class="fa fa-window-restore" aria-hidden="true"></i></a>
