            ...
            <table class="table table-striped" width="100%">
                ...
                <tbody>
                    ...
                    <?php
                                                ...
                                                ?>
                    <tr>
                        <td style="text-align: right;padding-right: 10px; " colspan="2" style="border: 0px">
                            <b><?php echo display('grand_total') ?>:</b></td>
                        <td style="text-align: right;padding-right: 10px; " style="border: 0px">
                            <b><?php echo $subTotal_quantity;?></b></td>
            ...
            <div class="table-responsive m-b-20">
                <table class="table">
                    ...
                    <tr>
                        ...
                        <th class="text-right"
                            style="border-top: 0; border-bottom: 0;text-align: right;padding-right: 10px;">
                    ...
                    <?php
                                        ...
                                        if ($invoice_detail[0]['total_vat_amnt'] != 0) {
                                            ?>
                    <tr>
                        <th style="border-top: 0; border-bottom: 0;text-align: right;"><?php echo display('ttl_val') ?> : </th>
                        <th class="text-right"
                            style="border-top: 0; border-bottom: 0;text-align: right;padding-right: 10px;">
                    ...
                    <?php
                                        ...
                                        if ($invoice_detail[0]['total_tax'] != 0) {
                                            ?>
                    <tr>
                        <th class="text-left" style="border-top: 0; border-bottom: 0;text-align: right;">
                            <?php echo display('tax') ?> : </th>
                        <th class="text-right"
                            style="border-top: 0; border-bottom: 0;text-align: right;padding-right: 10px;">
                            <?php echo (($position == 0) ? "$currency $total_tax" : "$total_tax $currency") ?> </th>
                    </tr>
                    <?php } ?>
                    ...
                    <tr>
                        <th class="text-left" style="border-top: 0; border-bottom: 0;text-align: right;">
                            <?php echo display('shipping_cost'); ?> : </th>
                        <th class="text-right"
                            style="border-top: 0; border-bottom: 0;text-align: right;padding-right: 10px;">
                    ...
                    <tr>
                        ...
                        <th style="text-align: right;padding-right: 10px; ">
                            <?php echo (($position == 0) ? "$currency $previous" : "$previous $currency") ?></th>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <th class="text-left grand_total" style="border-top: 0; border-bottom: 0;text-align: right;">
                            <?php echo display('paid_ammount') ?> : </th>
                        <th class="text-right grand_total"
                            style="border-top: 0; border-bottom: 0;text-align: right;padding-right: 10px;">
                            <?php echo (($position == 0) ? "$currency $paid_amount" : "$paid_amount $currency") ?></th>
                    </tr>
                    <?php
                                        if ($invoice_detail[0]['due_amount'] != 0) {
                                            ?>
                    <tr>
                        <th class="text-left grand_total" style="text-align: right; "><?php echo display('due') ?> :
                        </th>
                        <th style="text-align: right;padding-right: 10px; ">
                            <?php echo (($position == 0) ? "$currency $due_amount" : "$due_amount $currency") ?></th>
                    </tr>
                    <?php
                                        }
                                        ?>
