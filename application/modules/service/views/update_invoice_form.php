                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="vatpercent[]"
                                        ...
                                        value="<?php echo $details['vat']?>" min="0" tabindex="19" placeholder="0.00" />

                                </td>
                                <td>
                                    <input type="text" name="vatvalue[]" id="vat_value_<?php echo $sl;?>"
                                        class="form-control text-right total_vatamnt" min="0" tabindex="20"
                                        value="<?php echo $details['vat_amnt']?>" placeholder="0.00" readonly />
                                </td>
                                <!-- VAT end -->
                                ...
                                <td>
                                    ...
                                    <input type="hidden" id="total_discount_<?php echo $sl;?>" class="" value="<?php echo $details['discount_amount']?>" />
                                    <input type="hidden" id="all_discount_<?php echo $sl;?>" value="<?php echo $details['discount_amount']?>" class="total_discount dppr"
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    <input type="text" onkeyup="quantity_calculate(<?php echo $sl;?>);"
                                        ...
                                        class="form-control total_discount text-right" name="invoice_discount" placeholder="0.00"
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    <input type="text" id="total_vat_amnt" class="form-control text-right"
                                        name="total_vat_amnt" value="<?php echo $total_vat_amnt?>" readonly="readonly" />
                                </td>
                            </tr>
