                   ...
                   <?php echo form_open_multipart('tax/tax/update_tax_settins',array('class' => 'form-vertical','id' => 'tax_settings_update' ))?>
                    <div class="panel-body">
                    	...
                    	<div class="form-group row">
                            ...
                            <small ><ul>**Put the number of global TAX want to add**</ul></small>
                        </div>
                      ...
                      <?php $i++;}?>
                        ...
                        <div class="row text-center">
                           <h3> <span class="text-danger">If you Update TAX settings ,All of your previous TAX record will be destroyed.You Will Need to set TAX product wise and Service wise</span></h3>
                        </div>
                    </div>
                    <?php echo form_close()?>
