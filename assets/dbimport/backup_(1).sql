...
INSERT INTO `acc_coa` (`HeadCode`, `HeadName`, `PHeadName`, `PHeadCode`, `HeadLevel`, `IsActive`, `IsTransaction`, `IsGL`, `HeadType`, `IsBudget`, `IsDepreciation`, `customer_id`, `supplier_id`, `bank_id`, `service_id`, `DepreciationRate`, `CreateBy`, `CreateDate`, `UpdateBy`, `UpdateDate`) VALUES ('122000001', 'test service-1', 'Service Receive', NULL, '3', '1', '1', '0', 'A', '1', '1', NULL, NULL, NULL, '1', '1.00', '1', '2022-03-02 18:55:12', '', '0000-00-00 00:00:00');
...
INSERT INTO `acc_coa` (`HeadCode`, `HeadName`, `PHeadName`, `PHeadCode`, `HeadLevel`, `IsActive`, `IsTransaction`, `IsGL`, `HeadType`, `IsBudget`, `IsDepreciation`, `customer_id`, `supplier_id`, `bank_id`, `service_id`, `DepreciationRate`, `CreateBy`, `CreateDate`, `UpdateBy`, `UpdateDate`) VALUES ('2116000001', '1-JhonDoe', 'Employee Ledger', NULL, '4', '1', '1', '0', 'L', '0', '0', NULL, NULL, NULL, NULL, '0.00', '1', '2022-03-02 13:55:56', '', '0000-00-00 00:00:00');
...
INSERT INTO `acc_transaction` (`ID`, `VNo`, `Vtype`, `VDate`, `COAID`, `Narration`, `Debit`, `Credit`, `IsPosted`, `is_opening`, `CreateBy`, `CreateDate`, `UpdateBy`, `UpdateDate`, `IsAppove`) VALUES ('15', '4633675289', 'INV', '2022-03-02', '1141', 'Inventory credit For Invoice No', '0.00', '3200.00', '1', '0', '1', '2022-03-02 18:54:53', NULL, NULL, '1');
INSERT INTO `acc_transaction` (`ID`, `VNo`, `Vtype`, `VDate`, `COAID`, `Narration`, `Debit`, `Credit`, `IsPosted`, `is_opening`, `CreateBy`, `CreateDate`, `UpdateBy`, `UpdateDate`, `IsAppove`) VALUES ('16', '4633675289', 'INV', '2022-03-02', '113100000001', 'Customer debit For Invoice No -   Customer walking customer', '4200.00', '0.00', '1', '0', '1', '2022-03-02 18:54:53', NULL, NULL, '1');
INSERT INTO `acc_transaction` (`ID`, `VNo`, `Vtype`, `VDate`, `COAID`, `Narration`, `Debit`, `Credit`, `IsPosted`, `is_opening`, `CreateBy`, `CreateDate`, `UpdateBy`, `UpdateDate`, `IsAppove`) VALUES ('17', '4633675289', 'INV', '2022-03-02', '511001', 'Product Sales revenue For Invoice NO -  Customer walking customer', '0.00', '4000.00', '1', '0', '1', '2022-03-02 18:54:53', NULL, NULL, '1');
INSERT INTO `acc_transaction` (`ID`, `VNo`, `Vtype`, `VDate`, `COAID`, `Narration`, `Debit`, `Credit`, `IsPosted`, `is_opening`, `CreateBy`, `CreateDate`, `UpdateBy`, `UpdateDate`, `IsAppove`) VALUES ('18', '4633675289', 'INV', '2022-03-02', '2114', 'Value added tax For Invoice NO -  Customer walking customer', '200.00', '0.00', '1', '0', '1', '2022-03-02 18:54:53', NULL, NULL, '1');
INSERT INTO `acc_transaction` (`ID`, `VNo`, `Vtype`, `VDate`, `COAID`, `Narration`, `Debit`, `Credit`, `IsPosted`, `is_opening`, `CreateBy`, `CreateDate`, `UpdateBy`, `UpdateDate`, `IsAppove`) VALUES ('19', 'serv-1', 'SERVICEPayment', '2022-03-02', '111000001', 'Paid amount for SERVICE No serv-1', '53.00', '0.00', '1', '0', '1', '2022-03-02 18:56:15', NULL, NULL, '1');
INSERT INTO `acc_transaction` (`ID`, `VNo`, `Vtype`, `VDate`, `COAID`, `Narration`, `Debit`, `Credit`, `IsPosted`, `is_opening`, `CreateBy`, `CreateDate`, `UpdateBy`, `UpdateDate`, `IsAppove`) VALUES ('20', 'serv-1', 'SERVICE', '2022-03-02', '511002', 'Service Revenue For SERVICE No serv-1', '0.00', '53.00', '1', '0', '1', '2022-03-02 18:56:15', NULL, NULL, '1');
INSERT INTO `acc_transaction` (`ID`, `VNo`, `Vtype`, `VDate`, `COAID`, `Narration`, `Debit`, `Credit`, `IsPosted`, `is_opening`, `CreateBy`, `CreateDate`, `UpdateBy`, `UpdateDate`, `IsAppove`) VALUES ('21', 'serv-1', 'SERVICE', '2022-03-02', '2114', 'Value added TAX For Service', '3.00', '0.00', '1', '0', '1', '2022-03-02 18:56:15', NULL, NULL, '1');
INSERT INTO `acc_transaction` (`ID`, `VNo`, `Vtype`, `VDate`, `COAID`, `Narration`, `Debit`, `Credit`, `IsPosted`, `is_opening`, `CreateBy`, `CreateDate`, `UpdateBy`, `UpdateDate`, `IsAppove`) VALUES ('22', 'serv-1', 'SERVICE', '2022-03-02', '113100000001', 'Customer debit For service No serv-1', '53.00', '0.00', '1', '0', '1', '2022-03-02 18:56:15', NULL, NULL, '1');
INSERT INTO `acc_transaction` (`ID`, `VNo`, `Vtype`, `VDate`, `COAID`, `Narration`, `Debit`, `Credit`, `IsPosted`, `is_opening`, `CreateBy`, `CreateDate`, `UpdateBy`, `UpdateDate`, `IsAppove`) VALUES ('23', 'serv-1', 'SERVICE', '2022-03-02', '113100000001', 'Customer credit for Paid Amount For Service No serv-1', '0.00', '53.00', '1', '0', '1', '2022-03-02 18:56:15', NULL, NULL, '1');
INSERT INTO `acc_transaction` (`ID`, `VNo`, `Vtype`, `VDate`, `COAID`, `Narration`, `Debit`, `Credit`, `IsPosted`, `is_opening`, `CreateBy`, `CreateDate`, `UpdateBy`, `UpdateDate`, `IsAppove`) VALUES ('24', 'serv-1', 'service', '2022-03-02', '122000001', 'Service Invoice', '50.00', '0.00', '1', '0', '1', '2022-03-02 18:56:15', NULL, NULL, '1');
...
INSERT INTO `designation` (`id`, `designation`, `details`) VALUES ('1', 'Sale Staff', '');
...
INSERT INTO `employee_history` (`id`, `first_name`, `last_name`, `designation`, `phone`, `rate_type`, `hrate`, `email`, `blood_group`, `address_line_1`, `address_line_2`, `image`, `country`, `city`, `zip`) VALUES ('1', 'Jhon', 'Doe', '1', '01548569854', '2', '10000', '', '', '', '', '', ' ', '', '');
...
INSERT INTO `invoice` (`id`, `invoice_id`, `customer_id`, `date`, `total_amount`, `paid_amount`, `due_amount`, `prevous_due`, `shipping_cost`, `invoice`, `offline_invoice_no`, `invoice_discount`, `total_discount`, `total_vat_amnt`, `total_tax`, `sales_by`, `invoice_details`, `is_credit`, `is_fixed`, `is_dynamic`, `status`, `bank_id`, `payment_type`, `is_online`) VALUES ('3', '4633675289', '1', '2022-03-02', '4200.00', '0.00', '4200.00', '0.00', '0.00', '1002', NULL, '0.00', '0.00', '200.00', NULL, '1', 'Thank you for shopping with us', '1', '1', '0', '1', NULL, '1', '1');
...
INSERT INTO `invoice_details` (`id`, `invoice_details_id`, `invoice_id`, `product_id`, `serial_no`, `description`, `quantity`, `rate`, `batch_id`, `supplier_rate`, `total_price`, `discount`, `discount_per`, `vat_amnt`, `vat_amnt_per`, `tax`, `paid_amount`, `due_amount`, `status`) VALUES ('5', '125916148729776', '4633675289', '65020469', '', NULL, '4.00', '1000.00', '111', '800', '4000.00', '0.00', '', '200.00', '5', '0.00', '0', '4200.00', '1');
...
INSERT INTO `product_service` (`service_id`, `service_name`, `description`, `charge`, `service_vat`, `is_fixed`, `is_dynamic`) VALUES ('1', 'test service', '', '50.00', '6', '1', '0');
...
INSERT INTO `service_invoice_details` (`id`, `service_id`, `service_inv_id`, `qty`, `charge`, `discount`, `discount_amount`, `vat`, `vat_amnt`, `total`) VALUES ('1', '1', 'serv-1', '1.00', '50.00', '0.00', '0.00', '6.00', '3.00', '50.00');
...
INSERT INTO `tax_collection` (`id`, `date`, `customer_id`, `relation_id`) VALUES ('1', '2022-03-02', '1', 'serv-1');
