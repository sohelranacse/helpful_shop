 ...
 "use strict"; 
    ...
    $.ajax({
        url : base_url + "account/accounts/debtvouchercode/" + id,
        type: "GET",
        dataType: "json",
        success: function(data)
        {
...
/*Opening balance part*/
 ...
 function get_subtypeCode(id,sl){
    var base_url = $("#base_url").val();
    $.ajax({
        url : base_url + "account/accounts/getsubtypbyid/" + id,
        type: "GET",
        dataType: "json",
        success: function(data)
        {          
...
/*Opening balance part*/
 ...
 function load_subtypeOpen(id,sl){
    ...
    $.ajax({
        url : base_url + "account/accounts/getsubtypecode/" + id,
        type: "GET",
        dataType: "json",
        success: function(data)
        {
...
function calculationDebtv(sl) {
 ...
 "use strict"; 
   ...
   /* Generel Ledger part*/
    ...
    //         var csrf_test_name = $('[name="csrf_test_name"]').val();
    //         $.ajax({
    //              url: base_url + 'account/accounts/general_led',
    //             type: 'POST',
    //             data: {
    //                 Headid: Headid,
    //                 csrf_test_name:csrf_test_name
...
//    alert(areaval);
    var base_url = $("#base_url").val();
    $.ajax({
        url : base_url + "account/accounts/selectedform/" + id,
        type: "GET",
        dataType: "json",
        success: function(data)
        {
...
// check before submit data
  ...
  "use strict";
    function newdata(id){
       ...
       areaid++;
     $.ajax({
        url : base_url + "account/accounts/newform/" + id,
        type: "GET",
        dataType: "json",
        success: function(data)
        {
...
function delDataAcc(id){
    ...
    if(confm) {
        $.ajax({
        url : base_url + "account/accounts/deleteaccount/" + id,
        type: "GET",
        dataType: "json",
        success: function(data)
            {
