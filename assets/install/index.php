    ...
    <div class="container"> 
        ...
        <div class="row"> 
            <div class="col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1"> 
                <header class="header">
                    <h1 class="header-title"> :: Smart ERP software installer  ::</h1>
                </header>
                                ...
                                <div class="step-content step-five">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="text-center hide" id="btn-complete">
                                            <a href="index.php?complete=true&launchapp=true" class="btn btn-block cbtn">Click to launch your application </a>
                                        </div>
...
<footer class="footer text-center">
    <div class="container fText">
        <div class="col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1">
            <div class="row">
                <div class="col-sm-6 text-left">Developed by <a  target="_blank" href="https://www.xyzitsolution.com/">XYZ IT  SOLUTION</a></div>
                <div class="col-sm-6  text-right"><a target="_blank" href="https://forum.xyzitsolution.com/"><span class="glyphicon glyphicon-user"></span> Installation Support</a></div>
            </div>
        </div>
    </div>
</footer>
