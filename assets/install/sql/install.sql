...
INSERT INTO `customer_information` (`customer_id`, `customer_name`, `customer_address`, `address2`, `customer_mobile`, `customer_email`, `email_address`, `contact`, `phone`, `fax`, `city`, `state`, `zip`, `country`, `status`, `create_date`, `create_by`) VALUES(1, 'walking customer', '', '', '', '', '', '', '', '', '', '', '', '', 1, '2022-01-25 09:50:20', '2');
...
INSERT INTO `sub_module` (`id`, `mid`, `name`, `description`, `image`, `directory`, `status`) VALUES(null, 9, 'add_payment_method', NULL, NULL, 'add_payment_method', 1);
INSERT INTO `sub_module` (`id`, `mid`, `name`, `description`, `image`, `directory`, `status`) VALUES(null, 9, 'payment_method_list', NULL, NULL, 'payment_method_list', 1);
-- --------------------------------------------------------
