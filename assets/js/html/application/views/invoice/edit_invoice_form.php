                                ...
                                <tbody id="addinvoiceItem">
                                    ...
                                    <tr>
                                        <td class="" style="width: 200px;">
                                            <input type="text" name="product_name" onkeypress="invoice_productList({sl});" value="{product_name}-({product_model})" class="form-control productSelection" required placeholder='<?php echo display('product_name') ?>' id="product_names" tabindex="3">
                                        ...
                                        <td>
                                         ...
                                         <td>
                                         <select class="form-control" id="serial_no_{sl}" name="serial_no[]" "   style="width: 100px;">
