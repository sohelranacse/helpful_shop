                                ...
                                <div class="col-sm-12">
                                    ...
                                    <table class="table">
                                        ...
                                        if ($invoice_all_data[0]['total_discount'] != 0) {
                                            ?>
                                            <tr><td colspan="7" style="border-top: 0; border-bottom: 0;"></td>
                                                <td class="text-right" style="border-top: 0; border-bottom: 0;"> <strong><?php echo display('total_discount') ?> : </strong> </td>
                                                <td class="text-right" style="border-top: 0; border-bottom: 0;"> <strong><?php echo (($position == 0) ? "$currency {total_discount}" : "{total_discount} $currency") ?> </strong> </td>
                                            </tr>
                                            <?php
                                        }
                                        if ($invoice_all_data[0]['total_tax'] != 0) {
                                            ?>
                                            <tr><td colspan="7"></td>
                                                <td class="text-right" style="border-top: 0; border-bottom: 0;"><strong><?php echo display('tax') ?> : </strong></td>
                                                <td  class="text-right" style="border-top: 0; border-bottom: 0;"><strong><?php echo (($position == 0) ? "$currency {total_tax}" : "{total_tax} $currency") ?></strong> </td>
                                            </tr>
                                        <?php } ?>
                                         <?php if ($invoice_all_data[0]['shipping_cost'] != 0) {
                                            ?>
                                            <tr><td colspan="7" style="border-top: 0; border-bottom: 0;"></td>
                                                <td class="text-right" style="border-top: 0; border-bottom: 0;"><strong><?php echo display('shipping_cost') ?> :</strong> </td>
                                                <td class="text-right" style="border-top: 0; border-bottom: 0;"><strong><?php echo (($position == 0) ? "$currency {shipping_cost}" : "{shipping_cost} $currency") ?></strong> </td>
                                            </tr>
                                        <?php } ?>
                                         <?php if ($invoice_all_data[0]['previous'] != 0) {
                                            ?>
                                        <tr><td colspan="7" style="border-top: 0; border-bottom: 0;"></td>
                                            <td class="text-right grand_total" style="border-top: 0; border-bottom: 0;"><strong><?php echo display('previous'); ?> :</strong></td>
                                            <td class="text-right grand_total" style="border-top: 0; border-bottom: 0;"><strong><?php echo (($position == 0) ? "$currency {previous}" : "{previous} $currency") ?></strong></td>
                                        </tr>
                                         <?php } ?>
                                        <tr><td colspan="7"  style="border-top: 0; border-bottom: 0;"><strong><?php echo display('in_word')?>  {am_inword}</strong></td>
                                            <td class="text-right grand_total"  style="border-top: 0; border-bottom: 0;"><strong><?php echo display('grand_total') ?> :</strong></td>
                                            <td class="text-right grand_total" style="border-top: 0; border-bottom: 0;"><strong><?php echo (($position == 0) ? "$currency {total_amount}" : "{total_amount} $currency") ?></strong></td>
                                        </tr>
                                        <tr><td colspan="7" style="border-top: 0; border-bottom: 0;"></td>
                                            <td class="text-right grand_total" style="border-top: 0; border-bottom: 0;"><strong><?php echo display('paid_ammount') ?> :</strong> </td>
                                            <td class="text-right grand_total" style="border-top: 0; border-bottom: 0;"><strong><?php echo (($position == 0) ? "$currency {paid_amount}" : "{paid_amount} $currency") ?></strong></td>
                                        </tr>				 
                                        <?php
                                        if ($invoice_all_data[0]['due_amount'] != 0) {
                                            ?>
                                            <tr><td colspan="7" style="border-top: 0; border-bottom: 0;"></td>
                                                <td class="text-right grand_total" style="border-top: 0; border-bottom: 0;"><strong><?php echo display('due') ?> :</strong> </td>
                                                <td  class="text-right grand_total" style="border-top: 0; border-bottom: 0;"><strong><?php echo (($position == 0) ? "$currency {due_amount}" : "{due_amount} $currency") ?></strong></td>
                                            </tr>
                                            <?php
                                        }
                                        ?>
...
customer like you. Please give your, Reviews &amp; picture to our page &amp; group.
                             ...
                             <div class="row" style="margin-top: 50px">
                               ...
                               <div class="row" style="border-top:1px #333 solid;">
