                ...
                <div class="">
                    <table class="datatable2 table table-bordered table-hover">
                     ...
                     ?>
                              <tr id="show_vouchar">
                                  <td>
                                     <a href="<?php echo base_url("account/accounts/vouchar_cash/".$date) ?>">
                          ...
                          foreach($get_vouchar as $v_data){
                              ...
                              ?>
                              <tr>
                                  <td><a href="<?php echo base_url("account/accounts/vouchar_view/$v_data->VDate") ?>"><?php echo $v_data->VNo;;?></a></td>
...
<script type="text/javascript">
    $(document).ready(function(){
        $('#btnSerach').on('click',function(){
            ...
            $.ajax({
                url: '<?php echo site_url('account/accounts/voucher_report_serach'); ?>',
                type: 'POST',
                data: {
                    vouchar: vouchar
                },
