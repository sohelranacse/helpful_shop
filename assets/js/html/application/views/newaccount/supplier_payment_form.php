...
<div class="row">
    <div class="col-sm-12 col-md-12">
        <div class="panel panel-bd lobidrag">
            ...
            <div class="panel-body">
                         ...
                         <?= form_open_multipart('accounts/create_supplier_payment') ?>
   ...
   <option value="<?php echo $suplier->supplier_id;?>"><?php echo $suplier->supplier_name;?></option>
         <?php }?>
       </select>
...
<script type="text/javascript">
  ...
  function load_code(id,sl){
    ...
    $.ajax({
        url : "<?php echo site_url('accounts/supplier_headcode/')?>" + id,
        type: "GET",
        dataType: "json",
