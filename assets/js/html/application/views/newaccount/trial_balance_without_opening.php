    ...
    <div class="col-sm-12 col-md-12">
        <div class="panel panel-bd lobidrag">
            ...
            <div id="printArea">
                ...
                <h3 style="font-size:18px"><?php echo display('trial_balance')?><br/>
        ...
        ?>
                <tr class="table_head">
                  <td colspan="2" align="right" style="border-left: solid 1px #000; border-bottom: solid 1px #000; border-top: solid 1px #000;"><strong><?php echo display('total')?></strong></td>
                    ...
                    <table width="100%" cellpadding="1" cellspacing="20" style="margin-top: 50px">
                      <tr>
                          <td width="20%" style="border-top: solid 1px #000;" align="center"><?php echo display('prepared_by')?></td>
                            <td width="20%" style="border-top: solid 1px #000;" align="center"><?php echo display('account_official')?></td>
