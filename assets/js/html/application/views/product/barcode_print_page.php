                                            ...
                                            <?php if ($counter == $cqty) { ?>
                                                ...
                                                <td style="border: 1px solid black ;padding: 5px">      
                                                    ...
                                                    <div class="barcode-inner" style="font-family: 'Open Sans','Helvetica Neue',Helvetica,Arial,sans-serif;text-align: center; position: relative;">
                                                        ...
                                                        <img src="<?php echo base_url('Cbarcode/barcode_generator/{product_id}') ?>" class="img-responsive center-block" alt="" style="display: block;margin-left: auto;margin-right: auto;height: 60px;width: 143px;">
                                                        <div class="product-name-details" style="font-size: 11px;letter-spacing: 0.5px;font-weight: 600;text-transform: uppercase;line-height: 10px;">{product_name}</div>
