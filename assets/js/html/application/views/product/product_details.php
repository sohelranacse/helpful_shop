                                ...
                                <tbody>
                                    ...
                                    if ($salesData) {
                                        ...
                                        <tr> <td><?php echo $sl++;?></td>
                                            ...
                                            <td>
                                                <a href="<?php echo base_url() . 'Cinvoice/invoice_inserted_data/'.$sdata['invoice_id']; ?>">
                                                    <?php echo $sdata['invoice_id']?>
                                                </a>
                                            </td>
                                            <td>
                                                <a href="<?php echo base_url() . 'Cinvoice/invoice_inserted_data/'.$sdata['invoice_id']; ?>">
                                                   <?php echo $sdata['invoice']?>
                                                </a>
                                            </td>
                                            <td>
                                                <a href="<?php echo base_url() . 'Ccustomer/customer_ledger/'.$sdata['customer_id']; ?>"> <?php echo $sdata['customer_name']?></a>
                                            </td>
                                            <td style="text-align:right;"><?php echo $sdata['quantity']?></td>
                                            <td style="text-align:right;"> <?php echo (($position == 0) ? "$currency".$sdata['rate'] : $sdata['rate']."$currency") ?></td>
                                            <td style="text-align:right;"> <?php echo (($position == 0) ? "$currency".$sdata['total_price'] : $sdata['total_price']."$currency") ?></td>
                                            <td style="text-align:right;"> <?php echo (($position == 0) ? "$currency ".$sdata['total_amount'] : $sdata['total_amount']." $currency") ?></td>
                                        </tr>
