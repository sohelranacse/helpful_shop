            ...
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                 ...
                 <?php if($this->permission1->method('return_list','delete')->access()){ ?>
                                        <a href="<?php echo base_url() . 'Cretrun_m/delete_retutn_invoice/{invoice_id}'; ?>" class="btn btn-danger btn-sm" data-toggle="tooltip" data-placement="left" title="<?php echo display('invoice') ?>" onclick="return confirm('Do you want to delete it?')"><i class="fa fa-trash" aria-hidden="true"></i></a>
                                    <?php }?>
                                        <?php echo form_close() ?>
                                    </center>
                                    </td>
