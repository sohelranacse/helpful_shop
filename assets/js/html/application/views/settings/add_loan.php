...
<?php if($this->permission1->method('manage_person','read')->access()){ ?>
                  <a href="<?php echo base_url('Csettings/manage_person')?>" class="btn btn-primary m-b-5 m-r-2"><i class="ti-plus"> </i> <?php echo display('manage_loan')?> </a>
                  <?php }?>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                   ...
                   <?php echo form_open_multipart('Csettings/submit_loan',array('class' => 'form-vertical','id' => 'inflow_entry' ))?>
