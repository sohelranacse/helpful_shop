        ...
        <div class="row">
            <div class="col-sm-12">
             ...
             <?php if($this->permission1->method('add_office_loan','create')->access()){ ?>
                  <a href="<?php echo base_url('Cloan/add_office_loan')?>" class="btn btn-success m-b-5 m-r-2"><i class="ti-plus"> </i> <?php echo display('add_loan')?> </a>
               <?php }?>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                   ...
                   <?php echo form_open_multipart('Cloan/submit_payment',array('class' => 'form-vertical','id' => 'inflow_entry' ))?>
