...
<!--                    <a href="<?php echo base_url('data_synchronizer/form') ?>" class="btn btn-warning m-b-5 m-r-2"><i class="ti-align-justify"> </i> <?php echo display('setting') ?> </a>
                    <a href="<?php echo base_url('data_synchronizer/synchronize') ?>" class="btn btn-primary m-b-5 m-r-2"><i class="ti-align-justify"> </i> <?php echo display('synchronize') ?> </a>-->
                </div>
            </div>
        </div>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-4">  
                                ...
                                <?php } else { ?>
                                    ...
                                    <a href="<?php echo base_url('Backup_restore/download') ?>" class="btn btn-success w-md m-b-5 btn-block" onclick="return confirm('<?php echo display("are_you_sure") ?>')"><i class="fa fa-download"></i> <?php echo display('download') ?></a>

                                <?php } ?> 
                               <!--  <a href="<?php echo base_url('Backup_restore/delete') ?>" class="btn btn-danger w-md m-b-5 btn-block" onclick="return confirm('<?php echo display("are_you_sure") ?>')"><i class="fa fa-trash"></i> <?php echo display('delete') ?></a> -->
                                <?php echo form_close() ?> 
                            </div>  
                        </div>  
