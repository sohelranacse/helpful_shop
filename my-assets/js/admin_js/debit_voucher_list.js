...
var debitvList = $('#debitvList').DataTable({ 
       responsive: true,
     ...
     'lengthMenu':[[10, 25, 50,100,250,500,1000], [10, 25, 50,100,250,500,1000]],
      ...
      , {
          extend: "csv", title: "DebitVoucher",exportOptions: {
      ...
      , {
          extend: "excel",exportOptions: {
                 columns: [0,1,2,3,4,5 ,6,7,8] //Your Colume value those you want print
                     }, title: "DebitVoucher", className: "btn-sm prints"
      }
      , {
      ...
      , {
          extend: "print",exportOptions: {
                 columns: [ 0,1,2,3,4,5,6,7,8] //Your Colume value those you want print
                     },title: "<center> DebitVoucher</center>", className: "btn-sm prints"
      }
      ],
      ...
      'serverMethod': 'post',
      'ajax': {
         'url':base_url + 'account/accounts/CheckdebitvoucherList',
           "data": function ( data) {
