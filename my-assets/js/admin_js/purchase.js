    ...
    function addPurchaseOrderField1_old(divName){
  ...
  // Counts and limit for purchase order
    ...
    //Calculate store product
        "use strict";
    function calculate_store_old(sl) {
    ...
    function invoice_paidamount_old() {
    ...
    function product_pur_or_list(sl) {
        ...
        var options = {
           ...
           select: function( event, ui ) {
                ...
                let Item_id_A = document.getElementsByName("product_id[]")
                for(p = 0; p < Item_id_A.length; p++)
                {
                    console.log(Item_id_A[p].value, product_id)
                    // if(Item_id_A[p].value == product_id) {
